...
Rails.application.routes.draw do
  ...
  post '/game/change_game_settings_auto_flip_cards', to: 'game#changeGameSettingsAutoFlipCards'
  post '/game/change_game_settings_status_change', to: 'game#changeGameSettingsStatusChange'
  post '/game/change_status_user', to: 'game#changeStatusUser'
